//! `BasisServerTests/Networking`: one test binary, one module per C# file. The two hello-world
//! suites drive a real server over iroh; the rest exercise the server's state machines with
//! offline stand-in peers.
